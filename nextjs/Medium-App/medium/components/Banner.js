...
const styles = {
  accentedButton:
    "bg-black text-white py-2 px-4 rounded hover:opacity-60 cursor-pointer",
...
const Banner = () => {
  return (
    ...
    <div className={styles.content}>
      ...
      <Image  className='hidden h-32 md:inline-flex object-contain flex-1 ' src={Logo.src} width={500} height={400}/>
    </div>
    </div>
  ); 
};
